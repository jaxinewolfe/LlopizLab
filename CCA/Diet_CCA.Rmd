...
for (i in 1:length(fish)) {
  ...
  # Goal: Leave out prey categories that averaged less than 5% by number in the diet of each species
  ...
  tiff(paste0("CCA_", fish[i], ".tiff"),width = 8, height = 6, res = 200, units = "in")
