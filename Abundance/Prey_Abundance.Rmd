---
title: "Relative Prey Abundance in the Gut Content of Small Pelagic Fish along the Northeast U.S. Shelf"
author: "Jaxine Wolfe"
date: "7/28/2019"
...
for(i in 1:length(cruises)) {
  ...
  p <- ggplot(data = sca_prop, aes(Species, PreyProp, fill = taxon_bins)) +
    ...
    labs(title = paste0("Diet Composition Per Fish for Cruise ", cruises[i]), 
         x = "Fish Species", y = "Proportion in Diet") +
    theme_classic()
