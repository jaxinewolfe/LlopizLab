...
# man.data <- read.csv("https://raw.githubusercontent.com/klqi/EDI-NES-LTER-2019/master/namespace_validation/20190529_classify_classlabel.csv")
# man.data <- read.csv("classify_NOAA_sample.csv", header = TRUE)

my_path <- "/Users/jaxinewolfe/Documents/Research/PEP/NESLTER/Data/LlopizLab/Abundance/namespace_validation/resolved.csv"

# Load Justin data
preytype_Justin <- read.csv("classify_Forage_Fish_Diet_Data_2013_2015_Final_long.csv", 
...
preytype_Sarah <- read.csv("classify_LTER201802StomachData_LTERFFSizes.csv", 
...
# write.csv(as.data.frame(Llopiz_preytypes), file = "Llopiz_preytypes.csv")
